  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <div className="flex justify-center my-10">
            <a href="#" className='bg-gradient-to-r active:scale-90 from-orange-500 to-orange-800 px-4 py-3 mx-3 rounded-md'>
                Start for free
            </a>
            <a href="#" className=" py-3 px-4 active:scale-90 mx-3 rounded-md border">
                Documentation
            </a>
        </div>
